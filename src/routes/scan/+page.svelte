...
<div class="page-container">
	...
	<div class="pointer-events-none absolute -top-10 left-0 h-96 w-96 rounded-full bg-primary-container/20 blur-[120px]"></div>
	<div class="pointer-events-none absolute top-1/3 right-0 h-80 w-80 rounded-full bg-secondary-container/15 blur-[110px]"></div>
			...
			<div class="glass-card p-6 shadow-xl">
				<div class="mb-4 flex items-center justify-between">
					<div class="flex items-center gap-2">
						<span class="material-symbols-outlined text-[18px] text-secondary">filter_center_focus</span>
						<span class="font-mono-data text-xs uppercase tracking-wider text-secondary">Optical Aperture</span>
					</div>
					<div class="flex items-center gap-1.5 font-mono-data text-xs text-on-surface-variant">
				...
				>
					<!-- Corner brackets -->
					<span class="pointer-events-none absolute top-3 left-3 h-4 w-4 border-t-2 border-l-2 border-secondary/60"></span>
					<span class="pointer-events-none absolute top-3 right-3 h-4 w-4 border-t-2 border-r-2 border-secondary/60"></span>
					<span class="pointer-events-none absolute bottom-3 left-3 h-4 w-4 border-b-2 border-l-2 border-secondary/60"></span>
					<span class="pointer-events-none absolute bottom-3 right-3 h-4 w-4 border-b-2 border-r-2 border-secondary/60"></span>

					<div class="relative z-10 flex flex-col items-center gap-3">
						<div class="relative flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-tr from-primary-container/40 to-secondary-container/40 text-secondary shadow-lg">
						...
						<div class="mt-2 flex items-center gap-2">
							...
							<span class="rounded bg-surface-container px-2.5 py-1 font-mono-data text-[11px] text-on-surface-variant">PNG</span>
							<span class="rounded bg-surface-container px-2.5 py-1 font-mono-data text-[11px] text-on-surface-variant">WEBP</span>
						</div>
						<input
							type="file"
							accept="image/*"
